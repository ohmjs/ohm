...
Grammar.prototype = {
  ...
  matchContents: function(obj, startRule, optThrowOnFail) {
    ...
    if (thunk === common.fail || !inputStream.atEnd()) {
      if (optThrowOnFail) {
        throw new MatchFailure(inputStream);
      } else {
        return false;
      }
    } else {
...
function MatchFailure(inputStream) {
...
MatchFailure.prototype.getPos = function() {
  return this.inputStream.getMaxPosSeen();
};
