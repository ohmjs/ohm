...
Grammar.prototype = {
  ...
  toSemanticActionTemplate: function(/* entryPoint1, entryPoint2, ... */) {
    // TODO: try to find a good place to put the super-grammar's templates (they should be close to the other
    // cases for the same rules, etc.)
    // TODO: if the caller supplies entry points, only include templates for rules that are actually being called!
    var dict = {}
