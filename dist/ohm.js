...
pexprs.Apply.prototype.check = function(grammar, vals) {
  ...
  return body.check(grammar, ruleNode.children) && ruleNode.children.length === body.getArity();
};
